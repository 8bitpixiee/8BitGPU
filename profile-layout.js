(() => {
 ...
 const nodes=[['being','.identity-card','.identity-title'],['notepad','#notepad','h2'],['favorites','#favorites','h2'],['collection','#collection','h2'],['connections','#connections','h2'],['photo1','.photo-window:nth-child(1)','figcaption'],['photo2','.photo-window:nth-child(2)','figcaption'],['photo3','.photo-window:nth-child(3)','figcaption']];
